...
__all__ = ['processing_command_start', 'processing_command_help', 'processing_command_add', 'processing_callback_add_marketplace',
           ...
           'processing_callback_menu_set', 'processing_callback_menu_del']